...
recent-talk = Ein <a href="https://www.facebook.com/BerkeleyBlockchain/videos/2006069823011271/">neuer Vortrag</a> (fängt ab ca. 20:00 an) mit 
    <a href="https://drive.google.com/file/d/0ByHuc4xBso7TaEpWSlozWlpxcVk/view">Folien</a>. 

older-talk = Ein <a href="https://www.youtube.com/watch?v=aYG0NxoG7yw">älterer Vortrag</a> mit 
    <a href="https://cyber.stanford.edu/sites/default/files/bramcohen.pdf">Folien</a>. <br />

tech-paper-link = Ein sehr <a href="https://eprint.iacr.org/2017/893">technisches Dokument</a> über Proofs of S
...
looking-to-hire = Wir sind auf der Suche nach technisch begabten Programmieren, die mit unseren Kryptographen zusammenarbeiten, 
    ...
    HackerRank Herausforderungen absolvieren uns den Link zu Ihrem HackerRank Profil sowie Ihrem Lebenslauf an <a href="mailto:jobs@chia.network">jobs@chia.network</a> schicken.
...
about-detail = Chia Network hat seinen Sitz in San Francisco und ist ein Unternehmen, dass darauf zielt, die Infrastruktur von Kryptowährungen zu verbessern. 
    Unser Geschäftsführer, Bram Cohen, ist bekannt für die Entwicklung von BitTorrent: das erste moderne dezentralisierte Netzwerk Protokoll und, neben anderen, 
    eine Inspiration für das Bitcoin Protokoll. Unser Gründerteam hat Erfahrung in den Kryptowährung und Finanz 
    Branchen, da wir von Tradehill, CryptoCorp und Lightning Labs kommen.
