...
financial-instituations = Entidades financieras

slogan = dinero verde para un mundo digital
...
tech-paper-link = Un <a href="https://eprint.iacr.org/2017/893">publicación académica</a> sobre pruebas de espacio.

news-link = Sigue los últimos artículos en la sección de <a href="/news">noticias</a>.
...
join-keybase = Únete a nuestro grupo de Keybase para participar en la discusión.

install-keybase = Instala y configura <a href="https://keybase.io/download">Keybase</a>

request-keybase-access = Ejecuta ésto en tu terminal:
